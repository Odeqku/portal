        ...
        <div class="col-md-6">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    {!! Form::open(['route' => 'studentDetails', 'method' => 'POST', 'enctype' =>
                    'multipart/form-data'])!!}
                    ...
                    <div class="form-group" style='display: none;' id='form2'>
                        ...
                        <div class="form-group form-control">
                            {{ Form::text('name', '', ['class'=>'form-action col-md-6', 'placeholder'=>"Next Of Kin's
                            Name"])}}
                        </div>

                        <div class="form-group form-control">
                            {{ Form::textarea('address', '', ['class' => 'form-action col-md-8', 'placeholder'=>'Next of
                            Kin\'s Address'])}}
                        </div>

                        <div class="form-group form-control">
                            {{ Form::text('relationship', '', ['class' => 'form-action col-md-6', 'placeholder'=>'Your
